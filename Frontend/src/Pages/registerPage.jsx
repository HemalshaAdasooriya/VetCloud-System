                    ...
                    <form className="space-y-8" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-4">
                            ...
                            <GoogleOAuthProvider clientId={import.meta.env.VITE_GOOGLE_CLIENT_ID}>
                                <div className="w-full flex justify-center border-2 border-slate-200 rounded-xl hover:border-slate-300 hover:bg-slate-50 bg-white shadow-sm hover:shadow-md transition-all duration-150 ease-in-out active:scale-95 active:shadow-inner active:bg-slate-100 active:border-slate-300 focus-within:ring-2 focus-within:ring-slate-400 focus-within:ring-offset-2 overflow-hidden py-1 cursor-pointer">
                                    <GoogleLogin
                            ...
                            <FacebookLogin
                                ...
                                render={({ onClick }) => (
                                    <button
                                        ...
                                        onClick={onClick}
                                        disabled={isLoading}
                                        className="w-full flex items-center justify-center gap-3 px-6 py-[10px] bg-[#1877F2] border-2 border-[#1877F2] rounded-xl hover:bg-[#166FE5] transition-all shadow-sm"
                                    >
