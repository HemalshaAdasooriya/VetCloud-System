                            ...
                            <FacebookLogin.default
                                ...
                                render={({ onClick }) => (
                                    <button
                                        ...
                                        onClick={onClick}
                                        disabled={isLoading}
                                        className="w-full flex items-center justify-center gap-3 px-6 py-[10px] bg-[#1877F2] border-2 border-[#1877F2] rounded-xl hover:bg-[#166FE5] hover:shadow-md transition-all duration-150 ease-in-out shadow-sm active:shadow-inner active:scale-95 active:shadow-inner active:bg-[#1877F2] active:border-[#1877F2] focus-within:ring-[#1877F2] focus-within:ring-offset-2 overflow-hidden py-1 cursor-pointer"
                                    >
