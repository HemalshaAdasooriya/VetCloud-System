...
export const getAppointmentsByOwner = (ownerId, callback) => {
    const sql = `
        SELECT
            ...
            an.health_report AS animal_health_report,
    ...
    db.query(sql, [ownerId], (err, results) => {
        ...
        const formattedResults = results.map(row => {
            ...
            return {
                ...
                animal_weight: row.animal_weight || 'N/A',
                animal_status: row.animal_status || 'Healthy',
                animal_health_report: row.animal_health_report || null,
